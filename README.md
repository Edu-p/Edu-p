...
- [secbert-pt](https://github.com/Edu-p/secbert-pt) - Source code for "Robustness of Language Models against Portuguese Harmful Prompts" (IJCNN). SecBERT, a BERTimbau-based classifier for detecting harmful and jailbreak prompts in Brazilian Portuguese.
